...
-- Üretim Zamanı: 25 Oca 2025, 21:18:11
-- Sunucu sürümü: 9.1.0
-- PHP Sürümü: 8.3.14
...
--
-- Tablo için tablo yapısı `model_bazli_satis`
--

DROP TABLE IF EXISTS `model_bazli_satis`;
CREATE TABLE IF NOT EXISTS `model_bazli_satis` (
  `model_adi` varchar(50) COLLATE utf8mb4_turkish_ci NOT NULL,
...
--
-- Tablo döküm verisi `model_bazli_satis`
--

INSERT INTO `model_bazli_satis` (`model_adi`, `model_id`, `yil_id`, `satis_sayisi`) VALUES
('Model Y Performance', 1, 2024, 1250),
('Model Y Long Range', 2, 2024, 3540),
('Model Y Arkadan Çekiş', 3, 2024, 14200);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `sarj_istasyon_kullanimi`
--

DROP TABLE IF EXISTS `sarj_istasyon_kullanimi`;
CREATE TABLE IF NOT EXISTS `sarj_istasyon_kullanimi` (
  `ay_id` varchar(50) COLLATE utf8mb4_turkish_ci NOT NULL,
  `kullanim_miktari` int NOT NULL,
  `kullanim_id` int NOT NULL,
  PRIMARY KEY (`kullanim_id`),
  KEY `ay_id` (`ay_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;

--
-- Tablo döküm verisi `sarj_istasyon_kullanimi`
--

INSERT INTO `sarj_istasyon_kullanimi` (`ay_id`, `kullanim_miktari`, `kullanim_id`) VALUES
('Ocak', 1200, 1),
('Şubat', 1350, 2),
('Mart', 1500, 3),
('Nisan', 1800, 4),
...
--
-- Tablo kısıtlamaları `model_bazli_satis`
--
ALTER TABLE `model_bazli_satis`
  ADD CONSTRAINT `model_bazli_satis_ibfk_1` FOREIGN KEY (`yil_id`) REFERENCES `yil` (`yil_id`);

--
-- Tablo kısıtlamaları `sarj_istasyon_kullanimi`
--
ALTER TABLE `sarj_istasyon_kullanimi`
  ADD CONSTRAINT `sarj_istasyon_kullanimi_ibfk_1` FOREIGN KEY (`ay_id`) REFERENCES `aylar` (`ay_id`);
